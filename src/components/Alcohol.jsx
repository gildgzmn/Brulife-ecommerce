    ...
    <div className="MenShoes container mx-auto" style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.bestSellersGrid}>
          <BestSellerProduct imageSrc="./src/assets/Alcohol1.png" />
          <BestSellerProduct imageSrc="./src/assets/Alcohol2.png" />
          <BestSellerProduct imageSrc="./src/assets/Alcohol3.png" />
          <BestSellerProduct imageSrc="./src/assets/Alcohol4.png" />
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.productGrid}>
          <AllProduct imageSrc="./src/assets/JackDaniels.png" />
          <AllProduct imageSrc="./src/assets/BlackLabel.png" />
          <AllProduct imageSrc="./src/assets/BlueLabel.png" />
          <AllProduct imageSrc="./src/assets/RedLabel.png" />
          <AllProduct imageSrc="./src/assets/Rum.png" />
          <AllProduct imageSrc="./src/assets/Martini.png" />
          <AllProduct imageSrc="./src/assets/Vodka.png" />
          <AllProduct imageSrc="./src/assets/Smirnoff.png" />
        </div>
      </section>
