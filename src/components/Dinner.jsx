    ...
    <div className="MenShoes container mx-auto" style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.bestSellersGrid}>
          <BestSellerProduct imageSrc="./src/assets/Dinner1.png" />
          <BestSellerProduct imageSrc="./src/assets/Dinner2.png" />
          <BestSellerProduct imageSrc="./src/assets/Dinner3.png" />
          <BestSellerProduct imageSrc="./src/assets/Dinner4.png" />
        </div>
      </section>

      {/* Banner Section */}
      <header style={styles.header}>
        <img src="./src/assets/DinnerHeroSemi.png" alt="Another Banner Image" style={styles.bannerImage} />
      </header>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.productGrid}>
          <AllProduct imageSrc="./src/assets/FreshMeal.png" />
          <AllProduct imageSrc="./src/assets/Beef.png" />
          <AllProduct imageSrc="./src/assets/Korean.png" />
          <AllProduct imageSrc="./src/assets/MapoTofu.png" />
          <AllProduct imageSrc="./src/assets/Steak.png" />
          <AllProduct imageSrc="./src/assets/Indian.png" />
          <AllProduct imageSrc="./src/assets/Skewers.png" />
          <AllProduct imageSrc="./src/assets/Pancit.png" />
        </div>
      </section>
