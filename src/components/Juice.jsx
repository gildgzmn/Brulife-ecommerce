    ...
    <div className="Beverages container mx-auto" style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.productGrid}>
          <AllProduct imageSrc="./src/assets/Juice1.png" />
          <AllProduct imageSrc="./src/assets/Beverages2.png" />
          <AllProduct imageSrc="./src/assets/Juice3.png" />
          <AllProduct imageSrc="./src/assets/Beverages4.png" />
          <AllProduct imageSrc="./src/assets/Juice5.png" />
          <AllProduct imageSrc="./src/assets/Juice6.png" />
          <AllProduct imageSrc="./src/assets/Beverages7.png" />
          <AllProduct imageSrc="./src/assets/Juice8.png" />
        </div>
      </section>
