    ...
    <div className="Beverages container mx-auto" style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.bestSellersGrid}>
          <BestSellerProduct imageSrc="./src/assets/Shake1.png" />
          <BestSellerProduct imageSrc="./src/assets/Shake2.png" />
          <BestSellerProduct imageSrc="./src/assets/Shake3.png" />
          <BestSellerProduct imageSrc="./src/assets/Shake4.png" />
        </div>
      </section>
      ...
      <section style={styles.section}>
        ...
        <div style={styles.productGrid}>
          ...
          <AllProduct imageSrc="./src/assets/ShakeBev2.png" />
          <AllProduct imageSrc="./src/assets/Beverages3.png" />
          <AllProduct imageSrc="./src/assets/ShakeBev4.png" />
          <AllProduct imageSrc="./src/assets/ShakeBev5.png" />
          <AllProduct imageSrc="./src/assets/Beverages6.png" />
          <AllProduct imageSrc="./src/assets/ShakeBev7.png" />
