  ...
  return (
    <div style={styles.productDetails}>
      <div style={styles.productHeader}>
        <img 
          src="./src/assets/product10.png" 
          alt="DogFood" 
          style={styles.productImage}
        />
        <div style={styles.productInfo}>
          <h1 style={styles.productName}>PAMPERS ALL NIGHT</h1>
      ...
      <div style={styles.relatedKids}>
        <div style={styles.kidsItem}>
          <img src="./src/assets/PampersBabyDry.png" alt="Kids" style={styles.kidsImage} />
          <p>PAMPERS BABY DRY</p>
          <p style={styles.price}>₱99.99</p>
          <p style={styles.rating}>⭐⭐⭐⭐⭐ 162</p>
          <Button style={styles.addToCart}>Add to Cart</Button>
        </div>
        <div style={styles.kidsItem}>
          <img src="./src/assets/PampersPants.png" alt="Kids" style={styles.kidsImage} />
          <p>PAMPERS PANTS</p>
          <p style={styles.price}>₱99.99</p>
          <p style={styles.rating}>⭐⭐⭐⭐⭐ 1401</p>
          <Button style={styles.addToCart}>Add to Cart</Button>
        ...
        <div style={styles.kidsItem}>
          <img src="./src/assets/PampersSwadllers.png" alt="Kids" style={styles.kidsImage} />
          <p>PAMPERS SWADDLERS</p>
          <p style={styles.price}>₱99.99</p>
