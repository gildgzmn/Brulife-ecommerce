  ...
  return (
    <div style={styles.productDetails}>
      <div style={styles.productHeader}>
        <img 
          src="./src/assets/product8.png" 
          alt="Shoes" 
          style={styles.productImage}
        />
        <div style={styles.productInfo}>
          <h1 style={styles.productName}>ZEPHYR LS</h1>
      ...
      <div style={styles.relatedShoes}>
        <div style={styles.shoesItem}>
          <img src="./src/assets/Palazzi.png" alt="SOLEIL" style={styles.shoesImage} />
          <p>PALAZZI LOW-TOP SNEAKERS</p>
          <p style={styles.price}>₱1999.99</p>
          <p style={styles.rating}>⭐⭐⭐⭐⭐ 162</p>
          <Button style={styles.addToCart}>Add to Cart</Button>
        </div>
        <div style={styles.shoesItem}>
          <img src="./src/assets/BarbieSpec.png" alt="SHOES" style={styles.shoesImage} />
          <p>BARBIE SPEC LOW-TOP SNEAKERS</p>
          <p style={styles.price}>₱1999.99</p>
          <p style={styles.rating}>⭐⭐⭐⭐⭐ 1401</p>
          <Button style={styles.addToCart}>Add to Cart</Button>
        </div>
        <div style={styles.shoesItem}>
          <img src="./src/assets/Peono.png" alt="BLAZAR L" style={styles.shoesImage} />
          <p>PEONO LOW-TOP SNEAKERS</p>
          <p style={styles.price}>₱1999.99</p>
